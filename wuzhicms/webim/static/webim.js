...
function openChatbox(url, height, width) {
	height = height || 600;
	width = width || 400;
	window.open(url, "_self","height="+height+",width="+width+",fullscreen=3,top=40,left=40,status=no,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no,fullscreen=no");
}
