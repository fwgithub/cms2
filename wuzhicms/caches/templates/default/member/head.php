        ...
        <div class="topnav_right">
            <ul class="nav navbar_top-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/wuzhicms/www/index.php?m=guestbook&f=myissue&v=newask">我要提问</a></li>
                        <li class="divider"></li>
...
<div class="logobox">
    <div class="container">
        ...
        <a href="<?php echo WEBURL;?>/index.php"><img src="<?php echo R;?>t2/image/logo_gr.png" height="60px;" style="max-width:180px;" title="首页"></a>
