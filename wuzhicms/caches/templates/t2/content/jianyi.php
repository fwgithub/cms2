...
<div id="main">
  <div class="jianyi"> 
    ...
    <div class="more_cont">
      <div class="more_tx">
       <span>重要说明：</span><a>此通道仅记录建议类的反馈，其他问题请您选择正确的提交入口。请详细描述您的意见内容。</a>
      </div>
      <div class="cont_form">
          <table cellpadding="0" cellspacing="0">
            <tr height="65">
                  <form class="form-horizontal"  name="myform" action="?m=guestbook&f=myissue&v=jianyi" method="post" enctype="multipart/form-data">
                      <td align="right" width="90"><span>标题：</span></td>
                      <td align="left" ><p><input type="text" name="biaoti" class="biaoti" maxlength="20" autocomplete="off"/></p></td>
                      <td align="left" ><p><input type="text" name="type"  style="display:none;" value="1"/></p></td>
            </tr>
             <tr>
               
                      <td align="right" valign="top" width="90"><span>您的建议：</span></td>
                      <td align="left" ><p><textarea name="yijian" class="yj_box" maxlength="250" minlength="5" ></textarea></p></td>
               
            </tr>
             <tr height="50">
               
                      <td align="right" width="90"><span>上传文件：</span></td>
                      <td align="left"><input type="file" name="yi_sc" class="scwj"/></td>

            </tr>
            <tr >
             <td colspan="2">

               <input type="submit" class="tijiao_btn" value="提交建议" onclick="return check(this.form)"/>
              </form>
             </td>
            </tr>
          </table>
