...
<script type="text/javascript">
    function check(form) {
        ...
        if(form.wenti_biaoti.value=='') {
            alert("请输入标题!");
            form.wenti_biaoti.focus();
            return false;
        }
        if(form.wentims.value==''){
            alert("请输入意见!");
            form.wentims.focus();
            return false;
        }
        if(form.wenti_sc.value==''){
            alert("请上传文件!");
            form.wenti_sc.focus();
            return false;
        }
  ...
  <div class="more_cont">
      ...
      <div class="cont_form">
          <table cellpadding="0" cellspacing="0">
            <tr height="65">
                 <form name="myform" action="?m=guestbook&f=myissue&v=wenti" method="post" enctype="multipart/form-data">
                      <td align="right" width="90"><span>标题：</span></td>
                      <td align="left"><p><input type="text" name="wenti_biaoti" class="biaoti" maxlength="20" autocomplete="off"/></p></td>
                     <td align="left" ><p><input type="text" name="type"  style="display:none;" value="3"/></p></td>
            </tr>
             <tr>
               
                      <td align="right" valign="top" width="90"><span>您的问题：</span></td>
                      <td align="left"><p><textarea name="wentims" class="yj_box" maxlength="250" minlength="5" ></textarea></p></td>
                
            </tr>
             <tr height="50">
               
                      <td align="right" width="90" ><span>上传文件：</span></td>
                      <td align="left"><input type="file" name="wenti_sc" class="scwj"/></td>
               
            </tr>
            <tr>
             <td colspan="2">
             
               <input type="submit" class="tijiao_btn" value="提交问题" onclick="return check(this.form)"/>
              </form>
             </td>
            </tr>
          </table>
