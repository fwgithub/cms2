...
<script type="text/javascript">
    ...
    <div class="jianyi">
        ...
        <div class="jianyi_mid">
            <div class="more_cont">
                <div class="act_head">
                    <img src="<?php echo R;?>t2/image/jianyi.png" width="72" title="建议反馈"/>
                    <span>建议反馈</span>
                ...
                <div class="tishi">
                    <div class="tishi_cont">
                        <div class="deng">
                            <img src="<?php echo R;?>t2/image/deng.jpg"/>
                        </div>
                        <div class="more_tx">
                ...
                <div class="cont_form">
                    <form class="form-horizontal"  name="myform" action="?m=guestbook&f=myissue&v=jianyi" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form_li">
                            ...
                            <div class="form_input">
                                <textarea name="yijian" class="yj_box" maxlength="250" minlength="5" ></textarea>
                            </div>
                        ...
                        <div class="form_li">
                            ...
                            <div class="form_input">
                                <input type="file" name="yi_sc" class="scwj"/>
                            </div>
                    ...
                    <div class="form_right">
                        <p>如果您有相关截图，请上传。如多张图片可打
                            包压缩以zip或rar的文件格式上传，[限制文件大小：2M以内]</p>
                    </div>
