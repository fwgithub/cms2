...
<div class="more_cont">
      ...
      <div class="cont_jbwg">
      <div class="jbxx_head">
                <a href="jbxx.html"  style="margin-left:60px;">举报不良信息</a>
                <a href="jbwg.html" class="jbhead_on">举报外挂</a>
              </div>
              <form method="post">
              <div class="form_li">
               ...
               <div class="form_li youxiqufu">
                 ...
                 <div class="form_li">
                  ...
                  <div class="form_input">
                    <input type="text"  class="wjm" name="changj" maxlength="25"/>
                  </div>      
               </div>  
                 <div class="form_li">
                  <div class="formli_left1">
                  ...
                  <div class="form_input">
                    <textarea name="jbtxt" class="jb_box" maxlength="250" minlength="5" ></textarea>
                     ...
                     <input type="submit" value="提交" class="small_btn1"/>
           </form>
